...
(cl:defmethod cl:initialize-instance :after ((m <KnxSet-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KnxSet-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name knx_service-srv:<KnxSet-request> is deprecated: use knx_service-srv:KnxSet-request instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <KnxSet-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader knx_service-srv:action-val is deprecated.  Use knx_service-srv:action instead.")
  (action m))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <KnxSet-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader knx_service-srv:target-val is deprecated.  Use knx_service-srv:target instead.")
  (target m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <KnxSet-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader knx_service-srv:value-val is deprecated.  Use knx_service-srv:value instead.")
  (value m))
...
(cl:defmethod cl:initialize-instance :after ((m <KnxSet-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KnxSet-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name knx_service-srv:<KnxSet-response> is deprecated: use knx_service-srv:KnxSet-response instead.")))

(cl:ensure-generic-function 'etat-val :lambda-list '(m))
(cl:defmethod etat-val ((m <KnxSet-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader knx_service-srv:etat-val is deprecated.  Use knx_service-srv:etat instead.")
  (etat m))

(cl:ensure-generic-function 'xml-val :lambda-list '(m))
(cl:defmethod xml-val ((m <KnxSet-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader knx_service-srv:xml-val is deprecated.  Use knx_service-srv:xml instead.")
  (xml m))
